...
'''This method is the furthest attempt at calculating circuit score to use for DNA engineering applications'''
...
def main():
    ...
    if len(componentdict)==select_num:
        ...
        for stronger_p in range(1,2):
            data_result = engineer_circuit(rf,data,componentdict,stronger_p)
